...
tmp_env = gym.make('CarRacing-v2', render_mode="rgb_array", continuous=False)

env = gym.wrappers.RecordVideo(tmp_env, "video", name_prefix="test-video", episode_trigger=lambda x: x % 2 == 0)
